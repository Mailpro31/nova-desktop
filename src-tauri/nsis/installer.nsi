; Custom NSIS template for Nova with portable mode support.
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Nova releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Nova Portable Mode"
    FileClose $0
